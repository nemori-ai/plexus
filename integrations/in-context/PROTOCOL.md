...
Once you're connected and your granted capabilities are callable, tell the owner you're ready — then wait for them to put you to work. Anything else, discover it from the live API and the docs it links. Your credential is your own PAT (minted when you enroll), never the owner's connection-key.
