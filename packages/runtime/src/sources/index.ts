 ...
 *
 * Registered first-party sources today: apple-calendar, apple-reminders, apple-mail,
 * apple-contacts, things, workspace, claudecode, codex, sysinfo. User extensions register at runtime via
 ...
 *  - `apple-calendar` / `apple-reminders` / `apple-mail` / `apple-contacts` / `things`
 *    — macOS osascript/JXA only.
