...
(
  ...
  exec env \
    ...
    PLEXUS_BROWSER_CONTROL_MODE="${PLEXUS_BROWSER_CONTROL_MODE:-launch}" \
    PLEXUS_BROWSER_CONTROL_ORIGINS="${PLEXUS_BROWSER_CONTROL_ORIGINS:-}" \
    PLEXUS_BROWSER_CONTROL_ATTACH_PORT="${PLEXUS_BROWSER_CONTROL_ATTACH_PORT:-9222}" \
    PLEXUS_BROWSER_CONTROL_UPLOAD_DIR="${PLEXUS_BROWSER_CONTROL_UPLOAD_DIR:-}" \
