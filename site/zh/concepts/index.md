...
（配方见 [home-gateway 示例](https://github.com/nemori-ai/plexus/tree/main/examples/home-gateway)）——以 connection-key 作为信任边界。它给任何 AI agent 一套统一的 AI 原生协议，
